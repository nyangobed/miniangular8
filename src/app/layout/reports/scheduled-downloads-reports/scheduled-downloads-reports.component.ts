...
@Component({
    selector: 'app-scheduled-downloads-reports',
    templateUrl: './scheduled-downloads-reports.component.html',
    styleUrls: ['./scheduled-downloads-reports.component.scss'],
    animations: [routerTransition()]
})
export class ScheduledDownloadsReportsComponent implements OnInit {
