...
@Component({
  selector: 'app-delete-component1',
  templateUrl: './delete-component1.component.html',
  styleUrls: ['./delete-component1.component.scss']
})
export class DeleteComponent1Component implements OnInit {
  ...
  constructor(private _dialogService: TdDialogService, private _viewContainerRef: ViewContainerRef, protected stewardService: HttpStewardService<any, any>, protected notify: Notify, public dialog: MatDialog) {
