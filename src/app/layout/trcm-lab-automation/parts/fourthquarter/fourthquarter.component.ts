...
@Component({
  selector: 'app-fourthquarter',
  templateUrl: './fourthquarter.component.html',
  styleUrls: ['./fourthquarter.component.scss'],
  animations: [routerTransition()]
})
export class FourthquarterComponent implements OnInit {
...
ngOnInit(): void {
      ...
      this.dtOptions = this.stewardService.intiateDataTable('atlas/orders/fourthQuater',
      [
        {
