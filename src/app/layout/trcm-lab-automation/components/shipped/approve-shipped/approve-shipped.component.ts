...
@Component({
  selector: 'app-approve-shipped',
  templateUrl: './approve-shipped.component.html',
  styleUrls: ['./approve-shipped.component.scss'],
  animations: [routerTransition()]
})
export class ApproveShippedComponent implements OnInit {
