...
export class ScreeningComponent implements OnInit, AfterViewInit{
  ...
  ngAfterViewInit() {
    this.renderer.listenGlobal('document', 'click', (event) => {
        if (event.target.hasAttribute('edit-config-id')) {
            this.router.navigate(['/trcm-lab-automation/components/screening/view-screening/' + event.target.getAttribute('edit-config-id') + '/update']);
        }
  if (event.target.hasAttribute('view-config-id')) {
            this.router.navigate(['/trcm-lab-automation/components/screening/view-screening/' + event.target.getAttribute('view-config-id') + '/view']);
