...
@Component({
    selector: 'app-approvedepartment',
    templateUrl: './approvedepartment.component.html',
    styleUrls: ['./approvedepartment.component.scss'],
    animations: [routerTransition()]
})
export class ApprovedepartmentComponent implements OnInit, AfterViewInit {
    ...
    ngOnInit(): void {
        ...
        this.dtOptions = this.stewardService.intiateDataTable('departments',
            ...
            {
                data: 'departmentId', orderable: false,
